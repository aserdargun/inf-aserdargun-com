...
class MemoryStorage implements StoragePort {
  ...
  async isDescendant(fileId: string, rootId: string) { return rootId === ids.public && this.descendants.has(fileId); }
}
...
function fixture(): { deps: PublicDependencies; storage: MemoryStorage } {
  ...
  return { storage, deps: { storage, publicRootId: ids.public, events: { readAll: async () => [createdEvent()] } } };
}
